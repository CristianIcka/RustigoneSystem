...
class CrearProductoWindow:
    def __init__(self, parent, db, inventario_window):
        ...
        self.maximize_btn = ctk.CTkButton(self.window, text="🗖", width=40, height=30, command=self.toggle_maximize, fg_color="#38A169", text_color="white")
    ...
    def create_widgets(self):
        ...
        self.codigo_entry.grid(row=0, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.nombre_entry.grid(row=1, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.descripcion_entry.grid(row=2, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.ganancia_entry.grid(row=4, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.precio_venta_entry = ctk.CTkEntry(form_frame, placeholder_text="Se calculará automáticamente")
        self.precio_venta_entry.grid(row=5, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.stock_entry.grid(row=6, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.stock_min_entry.grid(row=7, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.unidad_combo.grid(row=8, column=1, sticky="ew", pady=10, padx=(10, 0))
        ...
        self.categoria_combo.grid(row=9, column=1, sticky="ew", pady=10, padx=(10, 0))
