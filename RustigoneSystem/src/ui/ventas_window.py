...
class VentasWindow:
    ...
    def setup_responsive_window(self):
        ...
        try:
            ...
            # Tamaño adaptativo (80% de la pantalla)
            window_width = int(screen_width * 0.8)
            window_height = int(screen_height * 0.8)
            
            # Centrar ventana
            self.center_window(self.window, window_width, window_height, self.parent)
    ...
    def create_widgets(self):
        ...
        self.buscar_btn.grid(row=0, column=2, padx=10, pady=10)
...
#*************************************************************************
    def solicitar_monto_efectivo(self):
        ...
        self.monto_window.geometry("500x550")  # ✅ Más alto para asegurar espacio
        self.monto_window.transient(self.window)
        self.monto_window.grab_set()
        
        # Centrar ventana emergente
        self.center_window(self.monto_window, 500, 550, self.window)
    ...
    def confirmar_pago_tarjeta(self, medio_pago):
        ...
        confirm_window.geometry("500x550")  # ✅ Aumentado para asegurar espacio
        confirm_window.transient(self.window)
        confirm_window.grab_set()
        
        # Centrar ventana
        self.center_window(confirm_window, 500, 550, self.window)
...
"""
    ...
    def mostrar_resumen_venta(self, medio_pago, monto_recibido=0, vuelto=0):
        ...
        resumen_window.geometry("650x750")  # ✅ Tamaño aumentado
        resumen_window.transient(self.window)
        resumen_window.grab_set()
        
        # Centrar ventana emergente
        self.center_window(resumen_window, 650, 750, self.window)
...
"""
    ...
    def mostrar_error(self, mensaje):
        ...
        self.center_window(error_window, 400, 200, self.window)
    ...
    def mostrar_exito(self, mensaje):
        ...
        exito_window.geometry("400x200")
        exito_window.transient(self.window)
        exito_window.grab_set()
        
        # Centrar ventana de éxito
        self.center_window(exito_window, 400, 200, self.window)
    ...
    def mostrar_info(self, titulo, mensaje):
        ...
        # Centrar ventana informativa
        self.center_window(info_window, 400, 200, self.window)
