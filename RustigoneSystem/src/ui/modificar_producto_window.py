...
class ModificarProductoWindow:
    ...
    def create_widgets(self):
        ...
        try:
            ...
            self.nombre_entry.grid(row=1, column=1, sticky="w", pady=10, padx=10)
            ...
            self.stock_entry.grid(row=6, column=1, sticky="w", pady=10, padx=10)
            
            # Stock Mínimo
            ctk.CTkLabel(form_frame, text="Stock Mínimo:", 
                        font=ctk.CTkFont(weight="bold")).grid(row=7, column=0, sticky="w", pady=10, padx=10)
            self.stock_min_entry = ctk.CTkEntry(form_frame, width=300)
            self.stock_min_entry.insert(0, str(self.producto.get('stock_minimo', 1)))
            self.stock_min_entry.grid(row=7, column=1, sticky="w", pady=10, padx=10)
            ...
            self.unidad_combo.grid(row=8, column=1, sticky="w", pady=10, padx=10)
            ...
            self.categoria_combo.grid(row=9, column=1, sticky="w", pady=10, padx=10)
